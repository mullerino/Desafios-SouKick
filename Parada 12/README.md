...
> O projeto tem como objetivo construir um site utilizando tabelas, escolhi falar um pouco do Chalet Suisse, separando em várias páginas, possíveis de serem acessadas através do menu.

### Ajustes e melhorias

O projeto ainda está em desenvolvimento e as próximas atualizações serão voltadas nas seguintes tarefas:

- [ ] Centralizar logo e menu
- [ ] Atualizar rodapé
